...
Use GitHub's enabled **Report a vulnerability** button and private
[security-advisory form](https://github.com/dharmendrathinks/agent-fault-lab/security/advisories/new).
If that route is ever unavailable, open an issue asking for a private security
contact without posting vulnerability details. Wait for that route before sharing
a reproduction. Never include real secrets, customer data or third-party targets.
